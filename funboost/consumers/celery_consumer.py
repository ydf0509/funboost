...
to_be_start_work_celery_queue_name_list = []
...
class CeleryConsumer(AbstractConsumer):
    ...
    def _shedual_task(self):
        ...
        to_be_start_work_celery_queue_name_list.append(self.queue_name)
...
def realy_start_celery_worker( worker_name=None):
    queue_names_str = ','.join(to_be_start_work_celery_queue_name_list)
    # '--concurrency=200',
