...
from funboost import fabric_deploy, AbstractConsumer, AbstractPublisher, get_consumer, GlobalBoosters
from funboost.core.muliti_process_enhance import run_consumer_with_multi_process, multi_process_pub_params_list, FunctionResultStatusPersistanceConfig
...
class Booster(LoggerMixin):
    ...
    def __call__(self, *args2, **kwargs):
        return self.consuming_func_decorated(*args2, **kwargs)
