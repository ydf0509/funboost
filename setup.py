...
setup(
    ...
    license='BSD License',
    # packages=['douban'], #
    packages=find_packages() + ['funboost.beggar_version_implementation'],   # 也可以写在 MANiFEST.in
...
python setup.py bdist_wheel ; python -m twine upload dist/funboost-14.8-py3-none-any.whl
