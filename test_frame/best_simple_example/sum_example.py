...
from funboost.concurrent_pool import FlexibleThreadPool, FunboostBaseConcurrentPool
...
@boost(qps=7, boost_params=BoosterParamsMy(queue_name='task_queue_name1c', max_retry_times=4, qps=3, log_level=10,
