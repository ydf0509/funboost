...
@boost(queue_name="task_queue_name1", qps=5, broker_kind=BrokerEnum.SQLITE_QUEUE, log_level=20,boost_params=BoosterParams(queue_name='task_queue_name1',max_retry_times=4))
def task_fun(x, y):
    print(f'{x} + {y} = {x + y}')
