...
for news_typex in ['news', 'advice', 'drive']:  # 定时任务，语法入参是apscheduler包相同。每隔60秒查询一次首页更新,这个可以不要。
    fsdf_background_scheduler.add_timing_publish_job(crawl_list_page, 'interval', seconds=60, kwargs={"news_type": news_typex, "page": 1})
