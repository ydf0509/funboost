...
@task_deco('test_queue_10',broker_kind=BrokerEnum.RedisBrpopLpush,qps=1000,log_level=10,is_print_detail_exception=False,is_show_message_get_from_broker=False)
def f(x,y):
