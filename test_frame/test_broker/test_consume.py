...
@task_deco('20010',broker_kind=BrokerEnum.ZEROMQ,qps=2,log_level=10,is_print_detail_exception=False,is_show_message_get_from_broker=False)
def f(x,y):
...
if __name__ == '__main__':
    # f.consume()
    run_consumer_with_multi_process(f,2)