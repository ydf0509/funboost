...
@task_deco('test_queue70c', qps=10,broker_kind=BrokerEnum.KAFKA,concurrent_mode=ConcurrentModeEnum.SINGLE_THREAD,log_level=10,
...
if __name__ == '__main__':
    ...
    f.multi_process_pub_params_list([{'dictx':{"x":i,'y':i*2}} for i in range(100000,200000)],3)
