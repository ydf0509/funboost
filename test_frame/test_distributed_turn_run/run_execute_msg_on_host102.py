from test_frame.test_distributed_turn_run.run_distribute_msg import build_booster_really_execute_msg_on_host_by_ip, ip_102
...
booster_execute_msg_on_host = build_booster_really_execute_msg_on_host_by_ip(ip_102)
