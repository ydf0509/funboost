...
def add(a, b):
    ...
    time.sleep(random.randint(10, 15))  # 模拟做某事需要阻塞10秒种，必须用并发绕过此阻塞。
...
consumer_add = get_consumer('queue_test56', consuming_function=add, threads_num=5000, max_retry_times=2,
