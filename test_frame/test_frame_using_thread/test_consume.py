...
consumer_add = get_consumer('queue_test56', consuming_function=add, threads_num=500, max_retry_times=2,
                            ...
                            function_timeout=0, is_print_detail_exception=True,
                            msg_expire_senconds=3600, broker_kind=0, concurrent_mode=1,)  # 通过设置broker_kind，一键切换中间件为rabbitmq或redis等9种中间件或包。
