...
class Myclass:
    ...
    def __init__(self, x):
        self.obj_init_params_for_funboost: dict = get_obj_init_params_for_funboost(copy.copy(locals())) # 这行重要，实例方法作为消费函数，那么必须定义obj_init_params_for_funboost保存对象的 __init__ 入参，用于还原生成对象。
