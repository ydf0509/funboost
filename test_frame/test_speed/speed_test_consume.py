...
@task_deco('20000', broker_kind=BrokerEnum.ZEROMQ,concurrent_num=2, log_level=10, qps=2,concurrent_mode=ConcurrentModeEnum.THREADING,)
def f_test_speed(x):
    pass
    # logger.debug(x)
...
if __name__ == '__main__':
    ...
    run_consumer_with_multi_process(f_test_speed,4)
